...
To wszystko. Serwer jest gotowy. Własna nazwa, własny certyfikat TLS albo serwer za NAT-em: [opcje instalacji](docs/02-installation/install.md).
...
Wolisz zrobić to sam z poziomu serwera? [Wdróż wprost z gita](docs/README.md#3-put-a-site-online).
...
- **Cloudflare jednym podłączeniem.** DNS, tunele i cache między projektami, w tym strona z serwera za NAT-em. [Domeny i HTTPS](docs/05-capabilities/domains-and-ssl.md)
...
Cała procedura: [gdy wdrożenie się nie udaje](docs/09-deploy-failures/what-happens.md) · [co oznacza błąd](docs/09-deploy-failures/reading-errors.md).
...
Co jest zbierane, co nie, i wszystkie sposoby wyłączenia: [co jest zbierane](docs/08-telemetry/what-is-collected.md) · [jak to wyłączyć](docs/08-telemetry/how-to-turn-it-off.md).
