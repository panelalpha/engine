...
class UserController extends Controller
{
    ...
    public function clone(string $username, UserCloneRequest $request): UserResource
    {
        ...
        // ── Copy resource limits and settings from source ────────────────────
        $srcDetails = $srcUser->getDetails();

        $newDetails = [
            'home_dir'               => "/home/{$newUsername}",
            'mysql_prefix'           => $newUsername . '_',
