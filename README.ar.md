...
<p align="center"><img src="docs/assets/panelalpha-engine.svg" alt="PanelAlpha Engine" width="360"></p>
...
هذا كل شيء. خادمك جاهز. اسم خاص، أو شهادة TLS خاصة بك، أو خادم خلف NAT: [خيارات التثبيت](docs/02-installation/install.md).
...
تفضّل أن تفعلها بنفسك من الخادم؟ [النشر مباشرة من git](docs/README.md#3-put-a-site-online).
...
- **Cloudflare في اتصال واحد.** DNS والأنفاق والتخزين المؤقت عبر مشاريعك، بما في ذلك موقع على خادم خلف NAT. [النطاقات وHTTPS](docs/05-capabilities/domains-and-ssl.md)
...
الإجراء كاملاً: [حين يفشل النشر](docs/09-deploy-failures/what-happens.md) · [ماذا يعني الخطأ](docs/09-deploy-failures/reading-errors.md).
...
ما الذي يُجمع، وما لا يُجمع، وكل طرق التعطيل: [ما الذي يُجمع](docs/08-telemetry/what-is-collected.md) · [كيف تعطّله](docs/08-telemetry/how-to-turn-it-off.md).
...
نعم. PanelAlpha Engine أداة لوكلاء الذكاء الاصطناعي كي يديروا *خادمك*. تحتاج خادم VPS نظيفاً بنظام Debian أو Ubuntu، بذاكرة 2 غيغابايت ومعالج واحد على الأقل، تدخل إليه بحساب `root` عبر SSH. تبدأ بتشغيل تثبيت Engine بنفسك على ذلك الخادم. [ما الذي تحتاجه](docs/02-installation/install.md#before-you-start)
</details>
...
ملخّص مجهول: نوع التطبيق، والمرحلة التي انكسرت، ونهاية السجل بعد تنقيحها، والأسماء العامة للمواقع. ولا شيء من كودك أو أسماء مشاريعك أو بيانات دخولك أو هوية خادمك. يمكنك طباعة تقرير منتظر عبر `pae telemetry:show`، كما يمكنك تعطيل ذلك كله. التفاصيل: [القياس عن بعد](docs/08-telemetry/what-is-collected.md).
</details>
