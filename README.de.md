...
Das war's. Dein Server ist bereit. Eigener Name, eigenes TLS-Zertifikat oder ein Server hinter NAT: [Installationsoptionen](docs/02-installation/install.md).
...
Lieber selbst vom Server aus? [Direkt aus Git ausrollen](docs/README.md#3-put-a-site-online).
...
- **Cloudflare in einer Verbindung.** DNS, Tunnel und Caching für deine Projekte, auch um eine Seite von einem Server hinter NAT bereitzustellen. [Domains und HTTPS](docs/05-capabilities/domains-and-ssl.md)
...
Das ganze Vorgehen: [wenn ein Deploy fehlschlägt](docs/09-deploy-failures/what-happens.md) · [was die Fehlermeldung heißt](docs/09-deploy-failures/reading-errors.md).
...
Was erhoben wird, was nicht, und jeder Weg zum Abschalten: [was erhoben wird](docs/08-telemetry/what-is-collected.md) · [wie du es abschaltest](docs/08-telemetry/how-to-turn-it-off.md).
...
Willst du mitmachen? [`CONTRIBUTING.md`](CONTRIBUTING.md) bringt dich ins Laufen. Für die tieferen Konventionen für Mitwirkende und den Testablauf geht es zu [`AGENTS.md`](AGENTS.md).
