...
Ya está. Tu servidor está listo. Nombre propio, tu propio certificado TLS o un servidor detrás de NAT: [opciones de instalación](docs/02-installation/install.md).
...
¿Prefieres hacerlo desde el servidor? [Desplegar directamente desde git](docs/README.md#3-put-a-site-online).
...
- **Cloudflare en una conexión.** DNS, túneles y caché en tus proyectos, también para servir un sitio desde un servidor detrás de NAT. [Dominios y HTTPS](docs/05-capabilities/domains-and-ssl.md)
...
El procedimiento completo: [cuando un despliegue falla](docs/09-deploy-failures/what-happens.md) · [qué significa el error](docs/09-deploy-failures/reading-errors.md).
...
Qué se recoge, qué no, y todas las formas de apagarlo: [qué se recoge](docs/08-telemetry/what-is-collected.md) · [cómo apagarlo](docs/08-telemetry/how-to-turn-it-off.md).
...
¿Quieres participar? [`CONTRIBUTING.md`](CONTRIBUTING.md) te pone en marcha. Para las convenciones más profundas de quien contribuye y el flujo de pruebas, ve a [`AGENTS.md`](AGENTS.md).
